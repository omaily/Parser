...
func main() {
	...
	c.OnHTML("div.pagination", func(e *colly.HTMLElement) {
		...
		if !contains(pagesToScrape, linkNext) {
			if !contains(pagesDiscovered, linkNext) {
